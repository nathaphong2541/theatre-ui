...
export class ButtonComponent implements OnInit {
  ...
  impactClasses: Record<ButtonProps['tone'], Record<ButtonProps['impact'], string>> = {
    ...
    danger: {
      bold: 'bg-destructive text-foreground hover:bg-destructive/90 focus-visible:ring-destructive',
    ...
    info: {
      bold: 'bg-violet-500 text-foreground hover:bg-violet-600 focus-visible:ring-violet-500',
    ...
    light: {
      bold: 'bg-muted text-white hover:bg-muted/90 focus-visible:ring-muted',
      light: 'bg-muted/20 text-white hover:bg-muted focus-visible:ring-muted',
      none: 'bg-transparent text-white hover:bg-muted focus-visible:ring-muted',
    },
  };
